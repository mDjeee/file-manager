...
## Note
 ...
 - ***IMPORTANT*** Take note that on the root disk (f.e. '`C./`'), you do not need to type the `cd` command with a path separator ('`/`') as in the [Video](https://youtu.be/TmylgGP9QDk?t=6770), you can type the name of the folder without a separator ('`/`') -> `cd Users` instead of `cd ./Users`
